...
def crp_create_table():
    ...
    # Create the table rows using list comprehensions
    table_rows = [
        dash.html.Tr([dash.html.Th(header, style={'padding': '0 1vh'}) for header in headers])
    ] + [
        dash.html.Tr([dash.html.Td(cell, style={'padding': '0 1vh'}) for cell in row]) for row in rows_data
    ]
