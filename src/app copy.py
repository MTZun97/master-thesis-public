...
app.layout = html.Div(style={'background-color': background_color, 'padding': '2vh'},
    ...
    html.Div([
        html.H1('Cost Projection of Global Green Hydrogen Production Scenarios',
                style={'font-size': '3vw', 'color': header_color, 'margin-bottom': '0.5vh'}),
        html.P([
    ...
    html.Div([html.P([html.B("1. Country-wise Hydrogen Industry Landscape: Manfucturers, Projects, and Status Heatmap")],
                     style={'font-size': '2vw', 'color': text_color})],
             style={
        'margin-bottom': '1vh',
        'margin-left': '3vh'
    }),
    html.Div([html.P([html.B("1.1.Electrolyzer manufacturer count per country")],
                     style={'font-size': '1.8vw', 'color': text_color})],
             style={
        'margin-bottom': '1vh',
        'margin-left': '3vh'
    }),
    ...
    html.Div([
        html.Div([
            ...
            ], style={'font-size': '1vw', 'color': text_color, 'text-align': "justify", 'padding': '1vh',
                      'border-radius': '0.4vh', }),
        ], style={'width': '25%', 'display': 'inline-block', 'vertical-align': 'top', 'padding': '1vh',
        ...
        dcc.Graph(id='manufacturer-count',
                  ...
                  style={'width': '70%', 'display': 'inline-block', 'margin-left': '1.5vh',
    ...
    html.Div([
        html.Div([
            html.Label('Select Status of Projects:', style={
                'font-weight': 'bold', 'margin-bottom': '3vh', 'text-align': 'left', 'font-size': '1vw','margin-bottom': '2vh',}),
            dcc.Dropdown(
                id='status-dropdown',
                options=[
                    {'label': 'All', 'value': 'all'},
                ...
                style={'width': '100%', 'margin-bottom': '1.5vh',
                       'border-radius': '0.4vh', 'font-size': '1.3vw', 'text-align':'center'}
            ),
            html.P([
                "Considering the project statuses, approximately 97.8% of the identified projects are still in the early phases of development, which include the concept and feasibility study phases. Only 0.07% of projects have reached the operational stage, demonstrating the small number of hydrogen initiatives that have reached the commercialization stage. In addition, 2.1% of projects have reached the stage of Financial Investment Decision (FID) and are under construction, indicating the financial commitment to these ventures. Lastly, the rest of the initiatives are successful demonstrations of technologies related to hydrogen.",
                html.Br(), html.Br(), "Data Source: IEA Hydrogen Projects Database"
        ...
        dcc.Graph(id='choropleth', style={'width': '70%', 'display': 'inline-block', 'margin-left': '1.5vh',
    ...
    html.Div([
        html.Div([
            html.Label('Select Methodology of Electrolyzer Cost Reduction:', style={
                'font-weight': 'bold', 'margin-bottom': '3vh', 'text-align': 'left', 'font-size': '1vw'}),
            dcc.Dropdown(
                id='method-dropdown',
                options=[
        ...
        dcc.Graph(id='cost-reduction-plot', style={'width': '70%', 'display': 'inline-block', 'margin-left': '1.5vh',
                                                   'vertical-align': 'top', 'height': '70vh', }),
    ], style={'width': '100%', 'margin': '0 auto', 'padding': '2vh', 'border-radius': '0.5vh'}),
    ...
    html.Div([
        html.Div([
            html.Div([
                html.Label("Electrolyzer Type:", style={
                           'font-weight': 'bold', 'margin-bottom': '3vh', 'font-size': '1vw'}),
                dcc.Dropdown(
                    ...
                    value='alk',
                    style={'width': '100%', 'font-size': '1.3vw', 'text-align':'center'}
                ),
        ...
        dcc.Graph(id='lcoh_graph', style={'width': '70%', 'display': 'inline-block', 'margin-left': '1.5vh',
                                          'vertical-align': 'top', 'height': '70vh', }),
    ], style={'width': '100%', 'margin': '0 auto', 'padding': '2vh', 'border-radius': '0.5vh'}),

    html.Div([html.P([html.B("3.2. Sensitivity analysis of green hydrogen production coset")],
                     style={'font-size': '1.8vw', 'color': text_color})],
             style={
        'margin-bottom': '1vh',
        'margin-left': '1vh'
    ...
    html.Div([
        html.Div([
            html.Label('Change for sensitivity analysis (%)', style={
                       'display': 'inline-block', 'width': '25vh', "font-size": "1vw"}),
            dcc.Input(id='percent_change', type='number', value=30,
                      min=5, max=95, step=1,  style={'width': '10vh', 'font-size': '1.2vw', 'text-align':'center'}),
            html.Br(),
            html.Br(),
            html.Span("Define values for base scenario:", style={
                      'font-weight': 'bold', 'margin-bottom': '1vh', "font-size": "1vw"}),
            html.Br(),
            html.Div([
                html.Label('Startup year', style={
                           'display': 'inline-block', 'width': '25vh', 'font-size': '1vw'}),
                dcc.Input(id='startup_year', type='number', value=2020,
                          min=1992, max=2050, step=1, style={'width': '10vh', 'font-size': '1.2vw', 'text-align':'center'})
            ], style={'margin-bottom': '1vh'}),
            html.Div([
                html.Label('Capacity factor (%)', style={
                           'display': 'inline-block', 'width': '25vh', 'font-size': '1vw'}),
                dcc.Input(id='cap_factor', type='number', value=50,
                          min=10, max=95, step=5, style={'width': '10vh', 'font-size': '1.2vw', 'text-align':'center'})
            ], style={'margin-bottom': '1vh'}),
            html.Div([
                html.Label('Current Density (A/cm²)',
                           style={'display': 'inline-block', 'width': '25vh', 'font-size': '1vw'}),
                dcc.Input(id='current_density', type='number', value=1.5,
                          min=0.2, max=2, step=0.05, style={'width': '10vh', 'font-size': '1.2vw', 'text-align':'center'})
            ], style={'margin-bottom': '1vh'}),
            html.Div([
                html.Label('Electrolyzer Cost ($/kW)',
                           style={'display': 'inline-block', 'width': '25vh', 'font-size': '1vw'}),
                dcc.Input(id='electrolyzer_cost', type='number',
                          value=1000, style={'width': '10vh', 'font-size': '1.2vw', 'text-align':'center'})
            ], style={'margin-bottom': '1vh'}),
            html.Div([
                html.Label('Electrolyzer Efficiency (%)', style={
                           'display': 'inline-block', 'width': '25vh', 'font-size': '1vw'}),
                dcc.Input(id='electrolyzer_efficiency', type='number',
                          value=50, min=1, max=99, step=1, style={'width': '10vh', 'font-size': '1.2vw', 'text-align':'center'})
            ], style={'margin-bottom': '1vh'}),
            html.Div([
                html.Label('Water Rate ($/gal)',
                           style={'display': 'inline-block', 'width': '25vh', 'font-size': '1vw'}),
                dcc.Input(id='water_rate', type='number',
                          value=0.002, step=0.001, style={'width': '10vh', 'font-size': '1.2vw', 'text-align':'center'})
            ], style={'margin-bottom': '1vh'}),
            html.Div([
                html.Label('Electricity Price ($/MWh)',
                           style={'display': 'inline-block', 'width': '25vh', 'font-size': '1vw'}),
                dcc.Input(id='elect_price', type='number',
                          value=36, step=1, style={'width': '10vh', 'font-size': '1.2vw', 'text-align':'center'})
            ], style={'margin-bottom': '1vh'}),
        ...
        dcc.Graph(id='tornado_chart', style={'width': '70%', 'display': 'inline-block', 'margin-left': '1.5vh',
                                             'vertical-align': 'top', 'height': '70vh', }),
    ], style={'width': '100%', 'margin': '0 auto', 'padding': '2vh', 'border-radius': '0.5vh'}),
        ...
        html.Div([
            html.Div([
                html.Span("Define values for Additional Capital Cost:", style={
                          'font-weight': 'bold', 'margin-bottom': '1vh', "font-size": "1vw"}),
                html.Label('ASU Cost ($/tonO2)',
                           style={'display': 'inline-block', 'width': '30vh', "font-size": "1vw"}),
                dcc.Input(id='ASU_cost', type='number', value=200,
                          min=0, step=5, style={'width': '10vh'}),
                html.Br(),
                html.Br(),
                html.Span("Define values for base scenario:", style={
                          'font-weight': 'bold', 'margin-bottom': '1vh'}),
                html.Br(),
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Electricity Price ($/MWh)',
                           style={'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='electricity_price_O2', type='number',
                          value=36, min=0, step=1, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Electrolyzer Efficiency (%)', style={
                           'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='electrolyzer_efficiency_O2', type='number',
                          value=70, min=0, max=100, step=1, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Electrolyzer Cost ($/kW)',
                           style={'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='electrolyzer_cost_O2', type='number',
                          value=1000, min=0, step=5, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Capacity Factor (%)', style={
                           'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='capacity_factor_O2', type='number', value=60,
                          min=0, max=99, step=5, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Natural Gas Price ($/MWh)',
                           style={'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='NG_price', type='number', value=10,
                          min=0, step=1, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),
    ...
    html.Div([
        html.Div([
            html.Span("Carbon Tax Plot Parameters:",
            ...
            html.Div([
                html.Label('Natural Gas Price ($/MWh):',
                           style={'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='NG_price_CO2', type='number',
                          value=30, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Additional Cost of CCUS (%):', style={
                           'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='CCUS_percent', type='number',
                          value=30, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Capture Rate (%):', style={
                           'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='capture_rate', type='number', value=90,
                          min=0, max=100, step=5, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Carbon Tax ($/tonCO2):',
                           style={'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='carbon_tax', type='number',
                          value=100, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Electricity Price Start ($/kWh):',
                           style={'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='electricity_price_CO2_start',
                          type='number', value=10, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Electricity Price End ($/kWh):',
                           style={'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='electricity_price_CO2_end',
                          type='number', value=100, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Electrolyzer Efficiency (%):', style={
                           'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='electrolyzer_efficiency_CO2', type='number',
                          value=70, min=0, max=95, step=5, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Electrolyzer Cost ($/kW):',
                           style={'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='electrolyzer_cost_CO2', type='number',
                          value=1000, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.Label('Capacity Factor (%):', style={
                           'display': 'inline-block', 'width': '30vh'}),
                dcc.Input(id='capacity_factor_CO2', type='number', value=60,
                          min=0, max=95, step=5, style={'width': '10vh'})
            ], style={'margin-bottom': '1vh', "font-size": "1vw"}),

            html.Div([
                html.P([
                    "Hydrogen production's economic feasibility hinges greatly on electricity costs and carbon taxes. Currently, to rival grey hydrogen (gas price = $20/MWh ), green hydrogen necessitates electricity prices below $22/MWh, considering current electrolyzer expenses. In the short to medium term, SMR with CCS/CCUS seems to be the most budget-friendly production route, with or without carbon taxation."
                ], style={'font-size': '1vw', 'color': text_color, 'text-align': "justify", 'padding': '1vh',
                          'border-radius': '0.4vh', }),
            ], style={'margin-bottom': '1vh'}),
        ...
        dcc.Graph(id='carbon_tax_plot', style={'width': '70%', 'display': 'inline-block', 'margin-left': '1.5vh',
                                               'vertical-align': 'top', 'height': '70vh', }),
    ], style={'width': '100%', 'margin': '0 auto', 'padding': '2vh', 'border-radius': '0.5vh'}),
