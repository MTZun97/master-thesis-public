    ...
    html.Div([
        html.Div([
            ...
            dcc.Input(id='percent_change', type='number', value=30,
                      min=5, max=95, step=1,  style={'width': '50px'}),
            html.Br(),
            html.Br(),
            ...
            html.Div([
                html.P([
                  ...
                  'border-radius': '5px', "margin-left": "10px", 'height': '68vh',
                  'background-color': '#f9f9f9', 'padding': '10px'}),
        ...
        html.Div([
            ...
            html.Div([
                ...
                dcc.Input(id='electricity_price_O2', type='number',
                          value=36, min=0, step=1, style={'width': '50px'})
            ], style={'margin-bottom': '10px'}),
            ...
            html.Div([
                ...
                dcc.Input(id='electrolyzer_efficiency_O2', type='number',
                          value=70, min=0, max=100, step=1, style={'width': '50px'})
            ], style={'margin-bottom': '10px'}),
            ...
            html.Div([
                ...
                dcc.Input(id='electrolyzer_cost_O2', type='number',
                          value=1000, min=0, step=5, style={'width': '50px'})
            ], style={'margin-bottom': '10px'}),
            ...
            html.Div([
                ...
                dcc.Input(id='capacity_factor_O2', type='number', value=60,
                          min=0, max=99, step=5, style={'width': '50px'})
            ], style={'margin-bottom': '10px'}),
        ...
        html.Div([
            ...
            html.Div([
                ...
                dcc.Input(id='capture_rate', type='number', value=90,
                          min=0, max=100, step=5, style={'width': '50px'})
            ], style={'margin-bottom': '10px'}),
            ...
            html.Div([
                ...
                dcc.Input(id='electricity_price_CO2_start',
                          type='number', value=0.01, style={'width': '50px'})
            ], style={'margin-bottom': '10px'}),
            ...
            html.Div([
                ...
                dcc.Input(id='electricity_price_CO2_end',
                          type='number', value=0.11, style={'width': '50px'})
            ], style={'margin-bottom': '10px'}),
            ...
            html.Div([
                ...
                dcc.Input(id='electrolyzer_efficiency_CO2', type='number',
                          value=70, min=0, max=95, step=5, style={'width': '50px'})
            ], style={'margin-bottom': '10px'}),
            ...
            html.Div([
                ...
                dcc.Input(id='capacity_factor_CO2', type='number', value=60,
                          min=0, max=95, step=5, style={'width': '50px'})
            ], style={'margin-bottom': '10px'}),
