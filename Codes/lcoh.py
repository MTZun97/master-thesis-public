...
lcoh, lcoh_capital, lcoh_fixedop, lcoh_varop = cash_flow(startup_year= 2020, cap_factor= 0.8, current_density=0.25, stack_percent= 0.5,
                                                         electrolyzer_cost= 50, electrolyzer_efficiency= 60, mech_percent = 0.2,
                                                         elect_percent = 0.3,
                                                         elect_df= lcoe("onshore_wind_lcoe", "World"))